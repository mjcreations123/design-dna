...
constraint. Do not quietly demote a brand, cultural, accessibility, or owner
requirement into an aesthetic suggestion.

## Hard boundaries

Keep these evidence-bound:

- approved facts, claims, dates, prices, people, quotations, policies, and
  operating states;
- source authority, cultural authority, consent, privacy, rights,
  attribution, provenance, and generated-media status;
- working controls, direct routes, recovery, failure behavior, data
  integrity, and honest disclosure of unavailable capability;
- semantic structure, keyboard and touch operation, focus, contrast, reflow,
  alternatives, localization, language direction, and reduced-motion access;
- security, legal, platform, repository, deployment, and verified brand
  constraints;
...
- palette, material, texture, ornament, shape, illustration, iconography, and
  image treatment;
- composition, alignment, density, whitespace, overlap, scale, crop, and
  responsive transformation;
- opening, ending, route structure, visual hierarchy, content rhythm, and the
  balance between convention and surprise;
- motion, stillness, direct manipulation, sound, temporal behavior, or no
...
Record consequential decisions with an observable model:

| Decision ID | Concern | Decision | Reason and evidence | What should be observable | Adaptation or limit | Status and owner |
| --- | --- | --- | --- | --- | --- | --- |
...
- visual quality in its own terms, including type, composition, crop,
  spacing, color relationships, detail, and finish;
- truthful content and media, usable behavior, accessibility, performance,
  and resilience;
- meaningful differences among sibling routes or unrelated outputs when their
  jobs and project evidence differ;
