...
| `RISK-MEDIA-001` | The visual-media strategy does not fulfill the brief: a subject that depends on recognition, atmosphere, material, place, product, people, or use has no convincing way to convey it, or supplied/generated media misrepresents the subject. | Choose and art-direct an authorized media path or deliberately revise the direction; bind documentary claims, rights, crops, disclosure, performance, alternatives, and fallback. | A photographic, media-light, typographic, abstract, diagrammatic, illustrative, object-led, or generated-media direction is valid when honest, visually successful, and appropriate to the subject. Missing supplied media is an input to resolve, not a hidden instruction to choose either photography or its absence. |
...
| `RISK-COPY-001` | Public copy forms an unexplained generic rhetorical machine, makes vague or unsupported promises, uses ambiguous actions, or narrates internal design/prototype methodology, producer rationale, workflow, or data-model taxonomy instead of serving the visitor. | Use approved facts, concrete subject language, real consequences, meaningful labels and actions, and a claim ledger; keep private design, process, and system language internal. | Supplied voice, quotations, legal language, specialized terminology, and repeated safety/status text should remain when authoritative and useful. |
...
| `RISK-PARSE-001` | Prominent or data-shaped public text is false, irrelevant, incomprehensible for its audience, visually unresolved, or leaked from internal implementation. | Run the contextual parseable-text review and bounded residue checks; make the content truthful and understandable, clarify its expressive role, or remove the accidental residue. | Atmospheric, poetic, humorous, ceremonial, technical, marginal, repeated, or specialist language is valid when its role and rendered relationship work for the project. |
| `RISK-FONTPAINT-001` | The delivered type system does not match the intended system: a load, family-name, weight, style, axis, subset, specificity, or fallback problem changes the rendered voice, hierarchy, script coverage, or layout without an intentional decision. | Select evidence appropriate to the claim from the typography reference, keep registration, availability, computed style, delivery, metric, synthesis, fallback, and visual observations distinct, and fix the observed delivery or CSS cause. | An intentionally selected system or platform stack follows its documented verification branch and is not failed for having no downloadable font resource. |
