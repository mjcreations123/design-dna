...
Use this for greenfield work, redesigns, or any change that establishes or
...
- [Prove and select](#prove-and-select)
- [Pressure-test the rendered direction](#pressure-test-the-rendered-direction)

## Start from project authority and material

Establish:

- audience, situation, useful tasks or invitations, and accountable owner;
- approved content, facts, language, identity, people, places, objects,
  behavior, media, and cultural context;
- existing brand, system, repository, and production decisions in scope;
...
| Decision ID | Decision | Why it belongs | Expected observation | Adaptation or limit | Status and owner |
| --- | --- | --- | --- | --- | --- |
...
- Ask which languages, densities, symbols, reading behaviors, visual
  practices, histories, and local preferences matter.
- Treat regional or community norms as evidence, not noise to normalize.
- Do not use culture, disability, age, gender, family, work, religion, or
  place as costume.
- Verify unfamiliar symbols, sacred material, terminology, and representation
  with appropriate authority.
- Support directionality, translation expansion, font coverage, and
  locale-specific behavior where relevant.
- Describe the intended relationship to time in this project's language;
  do not infer nostalgia or futurism from category.

Currentness comes from understanding present context and executing the chosen
logic well, not from avoiding named ingredients or adopting the newest surface
fashion.
...
## Pressure-test the rendered direction

Ask questions appropriate to the candidate:

- Does it fulfill the actual brief and accountable owner's taste authority?
- Can people understand or enter the experience as intended?
- Which project evidence explains the consequential decisions?
- Is the visual execution convincing in type, spacing, composition, media,
  color relationships, details, and states?
- Are differences among routes or components explained by their jobs and
  content rather than random novelty?
- Are repeated choices systemic for a reason, or are they producer defaults?
- Can the logic adapt across relevant routes, content, devices, states,
  languages, inputs, and preferences?
- Does it remain truthful, accessible, performant enough, maintainable, and
  within rights and authority?

Do not require every direction to survive removal of its strongest medium. An
image-led identity may genuinely depend on images; a typographic work may
genuinely depend on type. Use removal tests only when they answer a declared
project question.
