...
Use for a maintained product, shared system, or production-bound surface. Keep
small concepts and one-off prototypes in their direction and review records.
...
- Functional, content, state, accessibility, performance, visual, cultural,
  and operational evidence actually completed:
